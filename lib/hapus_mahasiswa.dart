...
class HapusMahasiswaPage extends StatefulWidget {
  const HapusMahasiswaPage({Key? key}) : super(key: key);

  @override
  _HapusMahasiswaPageState createState() => _HapusMahasiswaPageState();
}

class _HapusMahasiswaPageState extends State<HapusMahasiswaPage> {
